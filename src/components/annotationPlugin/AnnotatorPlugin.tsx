...
import { createCommentThunk } from '@/redux/slices/comments/commentThunk';
...
import { setPageComments } from '@/redux/slices/comments/commentSlice';
...
export const AnnotatorPlugin: React.FC = () => {
  ...
  const handleSaveDraft = async () => {
    ...
    const data: Omit<Annotation, 'id' | 'createdAt'> = {
      ...
      pageId: (currentPages as any)?._id || (currentPages as any)?.id || "",
      slug: slug
    }
    addAnnotation(data);
    setDraft(null);
