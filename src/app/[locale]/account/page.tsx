    ...
    return (
      <div className="section-padding">
        <div className="container-custom max-w-md text-center">
          ...
          <h1 className="text-3xl font-bold mb-4">{t('My Account')}</h1>
          <p className="text-[var(--text-secondary)] mb-8">{t('Sign in to access your account.')}</p>
          <Link href={locale === 'en' ? '/login' : `/${locale}/login`} className="btn-primary">{t('Sign In')}</Link>
        </div>
      </div>
    );
  }
